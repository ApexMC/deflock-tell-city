...
export function CommunitySite() {
  ...
  return <div id="top">
    ...
    <main id="main">
      <section className="hero container" aria-labelledby="hero-title"><div className="hero-copy"><div className="location-tag"><MapPin size={14} /><span>TELL CITY, INDIANA</span><span className="tag-divider" />A COMMUNITY INITIATIVE</div><h1 id="hero-title">Our streets.<br />Our lives.<br /><span>Our privacy.</span></h1><p className="hero-description">Living in a small town shouldn’t mean leaving a searchable trail. Let’s take a closer look at license plate cameras—and have a say in their place in our community.</p><div className="hero-actions"><a className="action-button" href="#petition">Sign the petition <ArrowUpRight size={18} /></a><a className="secondary-action" href="#risks">Understand the risks <ArrowDown size={16} /></a><Link className="secondary-action" href="/public-records">Public records <ArrowUpRight size={16} /></Link></div><div className="hero-footnote"><Fingerprint size={20} /><span>Public safety matters. So does your privacy.</span></div></div><Journey /></section>
